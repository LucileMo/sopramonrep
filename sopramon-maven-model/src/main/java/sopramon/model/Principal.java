...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Félicitations votre compte est créé ! Donnez maintenant un nom à votre Sopramon : ");
		String n =lireChaine();
		...
		System.out.println("Séléctionner l'identifiant de votre Sopramon : ");
		for (Sopramon p : daoSopramon.findAll()) {
		...
		default : System.out.println("Veuillez saisir à nouveau : ");
 	    m = lireEntier();
